-- Complete recreation of edge_storage_interest table with all required columns
-- Run this SQL in your Supabase SQL editor

-- Drop the existing table if it exists (WARNING: This will delete all existing data)
DROP TABLE IF EXISTS edge_storage_interest CASCADE;

-- Create the table with all required columns
CREATE TABLE edge_storage_interest (
...
CREATE INDEX idx_edge_storage_interest_created_at ON edge_storage_interest(created_at);
CREATE INDEX idx_edge_storage_interest_email ON edge_storage_interest(email);
CREATE INDEX idx_edge_storage_interest_business_sector ON edge_storage_interest(business_sector);
CREATE INDEX idx_edge_storage_interest_interest ON edge_storage_interest(interest_local_storage);
CREATE INDEX idx_edge_storage_interest_latitude ON edge_storage_interest(latitude);
CREATE INDEX idx_edge_storage_interest_longitude ON edge_storage_interest(longitude);
